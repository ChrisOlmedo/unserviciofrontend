const Conditionals = () => {
    return (
        <div>
            ...
            <p>Bienvenido a [Nombre de la Aplicación] ("nosotros", "nuestro" o "la Aplicación"). Al utilizar nuestros servicios, aceptas estar sujeto a estos Términos y Condiciones ("Términos"). Por favor, léelos cuidadosamente. Si no estás de acuerdo con ellos, no deberás usar nuestra aplicación.</p>

            <h2>2. Descripción del Servicio</h2>
            <p>[Nuestra aplicación] proporciona una plataforma para conectar servicios domésticos y empresariales con usuarios finales en México. Los servicios incluyen la personalización de perfiles, la gestión de calificaciones e historial, y notificaciones. Podrán añadirse nuevas funcionalidades en el futuro.</p>
            ...
            <p>Recopilamos y utilizamos tu información personal según nuestra <a href="enlace-a-politicas">Política de Privacidad</a>. Esto incluye nombre, correo electrónico y otros datos necesarios para brindarte el servicio.</p>
            ...
            <h2>12. Contacto</h2>
            <p>Para cualquier duda o inquietud, puedes contactarnos en [correo-electrónico-de-contacto].</p>
        </div>
    );
};
